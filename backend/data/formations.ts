...
export const formations: Formation[] = [
  {
    ...
    sessions: [
      {
        id: "stage-2025-01-24",
        label: "Session week-end : 24 & 25 janvier 2026",
        startDate: "2026-01-24",
        endDate: "2026-01-25",
      },
      {
        id: "stage-2025-02-07",
        label: "Session week-end : 7 & 8 février 2026",
        startDate: "2026-02-07",
        endDate: "2026-02-08",
      },
      {
        id: "stage-2025-03-14",
        label: "Session week-end : 14 & 15 mars 2026",
        startDate: "2026-03-14",
        endDate: "2026-03-15",
      },
      {
        id: "stage-2025-03-28",
        label: "Session week-end : 28 & 29 mars 2026",
        startDate: "2026-03-28",
        endDate: "2026-03-29",
      },
      {
        id: "stage-2025-06-06",
        label: "Session week-end : 6 & 7 juin 2026",
        startDate: "2026-06-06",
        endDate: "2026-06-07",
      },
      {
        id: "stage-2025-06-27",
        label: "Session week-end : 27 & 28 juin 2026",
        startDate: "2026-06-27",
        endDate: "2026-06-28",
      },
      {
        id: "stage-2025-07-18",
        label: "Session week-end : 18 & 19 juillet 2026",
        startDate: "2026-07-18",
        endDate: "2026-07-19",
      },
      {
        id: "stage-2025-08-08",
        label: "Session week-end : 8 & 9 août 2026",
