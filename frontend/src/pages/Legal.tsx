    ...
    <div className="bg-brand-midnight text-white">
      <section className="mx-auto max-w-3xl px-6 py-16">
        ...
        <div className="mt-6 space-y-2 text-white/80">
          <p><strong>Éditeur du site :</strong> NK26 — SASU (en cours d'immatriculation)</p>
          <p><strong>Siège social :</strong> 8 rue Mercoeur, 44000 Nantes, France</p>
        ...
        <div className="space-y-4 text-sm leading-relaxed text-white/80">
          ...
          <p className="text-white/40">Dernière mise à jour : 15/10/2025</p>
        </div>
      </section>
    </div>
  );
